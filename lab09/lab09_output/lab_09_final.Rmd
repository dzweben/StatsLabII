...
H0: 1*μ_South + (-1)*μ_West = 0 (marginal means).
...
H0: 1*μ_Northeast,City + (-1)*μ_Northeast,Non‑City = 0.
...
H0: 1*μ_Midwest,City + (-1)*μ_Northeast,City = 0.
...
- City dwellers, NE vs MW & W: H0: 1*μ_C,NE + (-0.5)*μ_C,MW + (-0.5)*μ_C,W + 0*μ_C,S + 0*μ_NC,NE + 0*μ_NC,MW + 0*μ_NC,W + 0*μ_NC,S = 0
- Non-city dwellers, NE vs MW & W: H0: 1*μ_NC,NE + (-0.5)*μ_NC,MW + (-0.5)*μ_NC,W + 0*μ_NC,S + 0*μ_C,NE + 0*μ_C,MW + 0*μ_C,W + 0*μ_C,S = 0
- Interaction contrast: H0: 1*μ_C,NE + (-0.5)*μ_C,MW + (-0.5)*μ_C,W + (-1)*μ_NC,NE + 0.5*μ_NC,MW + 0.5*μ_NC,W + 0*μ_C,S + 0*μ_NC,S = 0
