...
R script to generate this - for fun!
...
scheffe_t_bonf <- sqrt((A - 1) * qf(1 - alpha/2, A - 1, df_err))
scheffe_t_bonf
...
Decision (Relaxation Therapy): |t| = 4.55 > 3.75, reject H0.  d~av~ = 0.50.
...
Decision (Control): |t| = 8.65 > 3.75, reject H0.  d~av~ = 0.94.
